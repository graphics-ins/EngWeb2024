...
def convert_xml_to_html(source_directory, output_directory):
    preHTML = """
    <!DOCTYPE html>
    <html lang="en">
        <head>
    ...
    posHTML = """
                ...
                <footer class="w3-container w3-light grey">
                    <h5>Generated by RuasDeBraga::EngWeb2024::A95458</h5>
                    <address>
    ...
    def generate_html_content(root):
        ...
        for figura in root.findall('.//figura'):
            image_path = "../MapaRuas - MB/" + figura.find('.//imagem').get('path').replace("../", "")
    ...
    for filename in os.listdir(source_directory):
        if filename.endswith('.xml'):
            ...
            output_filename = f"{rua_numero}-{rua_nome.replace(' ', '')}.html"
